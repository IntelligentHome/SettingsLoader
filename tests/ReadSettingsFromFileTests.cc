...
TEST(ReadSettingsFromFile, ReadSettingsFromFile1) {
    ...
    read_settings_from_file::ReadSettingsFromFile loader("../tests/SettingsFile01.txt");
...
TEST(ReadSettingsFromFile, ReadSettingsFromFile2) {
    ...
    read_settings_from_file::ReadSettingsFromFile loader("../tests/SettingsFile02.txt");
